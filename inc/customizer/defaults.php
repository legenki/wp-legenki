...
if ( ! function_exists( 'legenki_get_option_defaults' ) ) {
	...
	function legenki_get_option_defaults() {
		$defaults = array(
			...
			'legenki_color_general_links'             => '#444',
			...
			'legenki_footer_bg'                       => '#F6F8FA',
			'legenki_footer_heading_color'            => '#444',
			'legenki_footer_color'                    => '#444',
			'legenki_footer_links_color'              => '#444',
